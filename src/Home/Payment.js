...
function Payment(){
    ...
    useEffect(()=>{
      ...
      axios.get(`https://shopmedic.herokuapp.com/product/${idProducttobuy}`)
...
const handleSubmit = (e) => {
    ...
    axios.post('https://shopmedic.herokuapp.com/Home/Checkout/Payment',Payment)
    .then(res => {
    if(res.error){
    return false
    }else{
    ...
    //   axios.post('https://shopmedic.herokuapp.com/Checkout/checkout',{token,product2})
    //   .then(function (response) {
