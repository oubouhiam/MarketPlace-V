...
useEffect(()=>{
  ...
  axios.get(`https://shopmedic.herokuapp.com/products`)
...
useEffect(()=>{
  ...
  axios.get(`https://shopmedic.herokuapp.com/category`)
    .then(function (response) {
...
useEffect(()=>{
  ...
  axios.get(`https://shopmedic.herokuapp.com/product/${gift_product}`)
    .then(function (response) {
