...
function LoginSuperAdmin() {
    ...
    const handleSubmit = (e) => {
      ...
      const Delivrydata = {Delivry_Name,Type:id};
          axios.post(`https://shopmedic.herokuapp.com/Delivry/add`,Delivrydata)
            .then(res => {
              if(res.error){
              return false
          }else{
                ...
                <div>
                  ...
                  <div className="flex -mx-3">
                    <div className="w-1/2 px-3 mb-5">
                      ...
                      <div className="flex">
                        ...
                        <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Name" 
                                   value={Delivry_Name}
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                      <button onclick={toastr} type="submit" className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">ADD</button>
                    </div>
                  </div>
                  </form>
                </div>
