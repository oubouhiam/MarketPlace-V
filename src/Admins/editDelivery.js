...
function LoginSuperAdmin() {
    ...
    useEffect(()=>{
        ...
        axios.get(`https://shopmedic.herokuapp.com/Delivry/${idDelevry}`)
    ...
    const handleSubmit = (e) => {
      ...
      const Delivrydata = {Delivry_Name,Type:id};
          axios.put(`https://shopmedic.herokuapp.com/Delivry/update/${idDelevry}`,Delivrydata)
            .then(res => {
              if(res.error){
              return false
          }else{
        ...
        <div className="md:flex w-full">
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div className="text-center mb-10">
              <h1 className="font-bold text-3xl text-gray-900">Add Delivery men</h1>
            </div>
            <div>
              ...
              <div className="flex -mx-3">
                <div className="w-1/2 px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input type="text" id="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Name" 
                               value={Delivry_Name}
                               onChange={e => setDelivry_Name(e.target.value)}/>
                  </div>
                </div>
                <div className="w-1/2 px-3 mb-5">
                  <label htmlFor className="text-xs font-semibold px-1">Service</label>
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg" /></div>
                              <select ref={(e) => idDelivry = e} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">
		...
		<option value="Express">Express</option>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  <button onclick={toastr} type="submit" className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Update</button>
                </div>
              </div>
              </form>
            </div>
